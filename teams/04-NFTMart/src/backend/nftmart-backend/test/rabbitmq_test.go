...
import (
	...
	"nftmart/app/utils/rabbitmq/hello_world"
	"nftmart/app/utils/rabbitmq/publish_subscribe"
	"nftmart/app/utils/rabbitmq/routing"
	"nftmart/app/utils/rabbitmq/topics"
	"nftmart/app/utils/rabbitmq/work_queue"
	_ "nftmart/bootstrap"
	"log"
	"os"
	"testing"
