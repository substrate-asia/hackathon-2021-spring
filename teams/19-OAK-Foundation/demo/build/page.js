...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "bufferToU8a": () => (/* binding */ bufferToU8a)
/* harmony export */ });
// Copyright 2017-2021 @polkadot/util authors & contributors
// SPDX-License-Identifier: Apache-2.0
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "hexHasPrefix": () => (/* binding */ hexHasPrefix)
/* harmony export */ });
...
function hexStripPrefix(value) {
  ...
  if ((0,_hasPrefix_js__WEBPACK_IMPORTED_MODULE_0__.hexHasPrefix)(value)) {
...
function isBn(value) {
  return bn_js__WEBPACK_IMPORTED_MODULE_0__.isBN(value);
}
...
function isHex(value, bitLength = -1, ignoreLength = false) {
  const isValidHex = value === '0x' || (0,_string_js__WEBPACK_IMPORTED_MODULE_0__.isString)(value) && HEX_REGEX.test(value.toString());
...
/* harmony export */ });
/* harmony import */ var _buffer_toU8a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../buffer/toU8a.js */ "../../node_modules/@polkadot/util/buffer/toU8a.js");
...
/* harmony import */ var _is_buffer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../is/buffer.js */ "../../node_modules/@polkadot/util/is/buffer.js");
/* harmony import */ var _is_hex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../is/hex.js */ "../../node_modules/@polkadot/util/is/hex.js");
/* harmony import */ var _is_string_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../is/string.js */ "../../node_modules/@polkadot/util/is/string.js");
/* harmony import */ var _string_toU8a_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../string/toU8a.js */ "../../node_modules/@polkadot/util/string/toU8a.js");
// Copyright 2017-2021 @polkadot/util authors & contributors
// SPDX-License-Identifier: Apache-2.0
...
function convertString(value) {
  return (0,_is_hex_js__WEBPACK_IMPORTED_MODULE_0__.isHex)(value) ? (0,_hex_toU8a_js__WEBPACK_IMPORTED_MODULE_1__.hexToU8a)(value) : (0,_string_toU8a_js__WEBPACK_IMPORTED_MODULE_2__.stringToU8a)(value);
}
/**
 * @name u8aToU8a
...
function u8aToU8a(value) {
  if (!value) {
    return new Uint8Array();
  } else if ((0,_is_buffer_js__WEBPACK_IMPORTED_MODULE_3__.isBuffer)(value)) {
    return (0,_buffer_toU8a_js__WEBPACK_IMPORTED_MODULE_4__.bufferToU8a)(value);
  } else if ((0,_is_string_js__WEBPACK_IMPORTED_MODULE_5__.isString)(value)) {
...
/* harmony import */ var _polkadot_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @polkadot/util */ "../../node_modules/@polkadot/util/logger.js");
/* harmony import */ var _polkadot_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @polkadot/util */ "../../node_modules/@polkadot/util/is/undefined.js");
...
const l = (0,_polkadot_util__WEBPACK_IMPORTED_MODULE_3__.logger)('PostMessageProvider');
// External to class, this.# is not private enough (yet)
let sendRequest;
/**
...
var _eventemitter = (0,_babel_runtime_helpers_esm_classPrivateFieldLooseKey__WEBPACK_IMPORTED_MODULE_1__.default)("eventemitter");

var _isConnected = (0,_babel_runtime_helpers_esm_classPrivateFieldLooseKey__WEBPACK_IMPORTED_MODULE_1__.default)("isConnected");

var _subscriptions = (0,_babel_runtime_helpers_esm_classPrivateFieldLooseKey__WEBPACK_IMPORTED_MODULE_1__.default)("subscriptions");
...
class PostMessageProvider {
  ...
  constructor(_sendRequest) {
    ...
    (0,_babel_runtime_helpers_esm_classPrivateFieldLooseBase__WEBPACK_IMPORTED_MODULE_0__.default)(this, _eventemitter)[_eventemitter] = new (eventemitter3__WEBPACK_IMPORTED_MODULE_2___default())();
    sendRequest = _sendRequest;
  }
  /**
  ...
  async send(method, params, subscription) {
    if (subscription) {
      ...
      (0,_babel_runtime_helpers_esm_classPrivateFieldLooseBase__WEBPACK_IMPORTED_MODULE_0__.default)(this, _subscriptions)[_subscriptions][`${type}::${id}`] = callback;
      return id;
    }
  ...
  async startProvider(key) {
    ...
    (0,_babel_runtime_helpers_esm_classPrivateFieldLooseBase__WEBPACK_IMPORTED_MODULE_0__.default)(this, _eventemitter)[_eventemitter].emit('disconnected');
    ...
    sendRequest('pub(rpc.subscribeConnected)', null, connected => {
      (0,_babel_runtime_helpers_esm_classPrivateFieldLooseBase__WEBPACK_IMPORTED_MODULE_0__.default)(this, _isConnected)[_isConnected] = connected;

      if (connected) {
        (0,_babel_runtime_helpers_esm_classPrivateFieldLooseBase__WEBPACK_IMPORTED_MODULE_0__.default)(this, _eventemitter)[_eventemitter].emit('connected');
      } else {
        (0,_babel_runtime_helpers_esm_classPrivateFieldLooseBase__WEBPACK_IMPORTED_MODULE_0__.default)(this, _eventemitter)[_eventemitter].emit('disconnected');
      }
  ...
  async unsubscribe(type, method, id) {
    ...
    if ((0,_polkadot_util__WEBPACK_IMPORTED_MODULE_4__.isUndefined)((0,_babel_runtime_helpers_esm_classPrivateFieldLooseBase__WEBPACK_IMPORTED_MODULE_0__.default)(this, _subscriptions)[_subscriptions][subscription])) {
...
/* harmony export */ });
/* harmony import */ var _Injected__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Injected */ "../extension-base/src/page/Injected.ts");
// Copyright 2019-2021 @polkadot/extension authors & contributors
// SPDX-License-Identifier: Apache-2.0
...
async function enable(origin) {
  ...
  return new _Injected__WEBPACK_IMPORTED_MODULE_0__.default(sendMessage);
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @polkadot/extension-base/page */ "../extension-base/src/page/index.ts");
/* harmony import */ var _polkadot_extension_inject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @polkadot/extension-inject */ "../extension-inject/src/index.ts");
// Copyright 2019-2021 @polkadot/extension authors & contributors
// SPDX-License-Identifier: Apache-2.0
...
window.addEventListener('message', ({
  ...
  if (data.id) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (0,_polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_0__.handleResponse)(data);
  } else {
    console.error('Missing id for response.');
  }
});
(0,_polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_0__.redirectIfPhishing)().then(gotRedirected => {
  if (!gotRedirected) {
    inject();
  }
}).catch(e => {
...
function inject() {
  (0,_polkadot_extension_inject__WEBPACK_IMPORTED_MODULE_1__.injectExtension)(_polkadot_extension_base_page__WEBPACK_IMPORTED_MODULE_0__.enable, {
    name: 'polkadot-js',
    version: "0.37.3-5"
  });
}
