module.exports = {
  ...
  rules: {
    // 解决iviews在eslint一直报 ‘[vue/no-parsing-error] Parsing error: x-invalid-end-tag.’
    ...
    'no-template-curly-in-string': 0, // 允许字符串里用模板字符串表达式
    'no-control-regex': 0,
    'no-useless-escape': 0,
    // allow debugger during development
    ...
    'id-length': 0, //变量名长度
    indent: [2, 2, { SwitchCase: 1, ignoredNodes: ['ConditionalExpression'] }], //缩进风格
