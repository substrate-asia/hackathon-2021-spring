...
use pangu_runtime::constants::currency::*;
...
pub type PanguChainSpec = sc_service::GenericChainSpec<GenesisConfig>;
...
pub fn pangu_config() -> Result<PanguChainSpec, String> {
	PanguChainSpec::from_json_bytes(&include_bytes!("../../res/pangu.json")[..])
}

pub fn staging_config() -> Result<PanguChainSpec, String> {
...
pub fn pangu_development_config() -> Result<PanguChainSpec, String> {
...
pub fn pangu_local_testnet_config() -> Result<PanguChainSpec, String> {
	let wasm_binary = WASM_BINARY.ok_or("Development wasm binary not available".to_string())?;
