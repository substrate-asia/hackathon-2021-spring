...
import { detectedCapabilities } from "./util.js";
...
export class Init extends Decorate {
  ...
  async getBlockRegistry(blockHash) {
    ...
    const registry = this._initRegistry(new TypeRegistry(blockHash), this._runtimeChain, version, metadata); // For now, since this is new we ignore the capability lookups (this could be useful once proven)
