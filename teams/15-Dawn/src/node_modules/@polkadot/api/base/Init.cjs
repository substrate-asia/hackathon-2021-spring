...
class Init extends _Decorate.Decorate {
  ...
  async getBlockRegistry(blockHash) {
    ...
    const registry = this._initRegistry(new _create.TypeRegistry(blockHash), this._runtimeChain, version, metadata); // For now, since this is new we ignore the capability lookups (this could be useful once proven)
