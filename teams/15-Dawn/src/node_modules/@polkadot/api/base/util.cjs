...
function mapCapabilities([systemRefcount32, systemRefcountDual, systemRefcountTriple, stakingVersion]) {
...
function detectedCapabilities(api, blockHash) {
  var _api$query$system, _api$query$system2, _api$query$system3, _api$query$staking;

  const all = [(_api$query$system = api.query.system) === null || _api$query$system === void 0 ? void 0 : _api$query$system.upgradedToU32RefCount, (_api$query$system2 = api.query.system) === null || _api$query$system2 === void 0 ? void 0 : _api$query$system2.upgradedToDualRefCount, (_api$query$system3 = api.query.system) === null || _api$query$system3 === void 0 ? void 0 : _api$query$system3.upgradedToTripleRefCount, (_api$query$staking = api.query.staking) === null || _api$query$staking === void 0 ? void 0 : _api$query$staking.storageVersion];
