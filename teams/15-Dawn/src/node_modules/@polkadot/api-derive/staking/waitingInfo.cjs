...
function waitingInfo(instanceId, api) {
  return (0, _index.memo)(instanceId, (flags = DEFAULT_FLAGS) => (0, _xRxjs.combineLatest)([api.derive.staking.validators(), api.derive.staking.stashes()]).pipe((0, _operators.switchMap)(([{
    nextElected
  }, stashes]) => {
