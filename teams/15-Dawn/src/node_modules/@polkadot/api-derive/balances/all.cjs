...
function calcShared(api, bestNumber, data, locks) {
  ...
  return _objectSpread(_objectSpread({}, data), {}, {
    availableBalance: api.registry.createType('Balance', allLocked ? 0 : (0, _util.bnMax)(new _bn.default(0), data.freeBalance.sub(lockedBalance))),
    lockedBalance,
    lockedBreakdown,
    vestingLocked
  });
...
function all(instanceId, api) {
  ...
  return (0, _index.memo)(instanceId, address => api.derive.balances.account(address).pipe((0, _operators.switchMap)(account => {
