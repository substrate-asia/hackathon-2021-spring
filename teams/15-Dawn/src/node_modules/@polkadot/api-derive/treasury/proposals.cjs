...
function proposals(instanceId, api) {
  return (0, _index.memo)(instanceId, () => api.query.treasury ? (0, _xRxjs.combineLatest)([api.query.treasury.proposalCount(), api.query.treasury.approvals()]).pipe((0, _operators.switchMap)(([proposalCount, approvalIds]) => retrieveProposals(api, proposalCount, approvalIds))) : (0, _xRxjs.of)({
    approvals: [],
