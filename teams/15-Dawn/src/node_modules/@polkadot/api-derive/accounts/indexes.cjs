...
function indexes(instanceId, api) {
  return (0, _index.memo)(instanceId, () => indicesCache ? (0, _xRxjs.of)(indicesCache) : (api.query.indices ? queryAccounts(api).pipe((0, _operators.startWith)({})) : (0, _xRxjs.of)({})).pipe((0, _operators.map)(indices => {
