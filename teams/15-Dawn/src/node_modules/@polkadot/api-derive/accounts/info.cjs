...
function info(instanceId, api) {
  return (0, _index.memo)(instanceId, address => api.derive.accounts.idAndIndex(address).pipe((0, _operators.switchMap)(([accountId, accountIndex]) => (0, _xRxjs.combineLatest)([(0, _xRxjs.of)({
    accountId,
    accountIndex
