...
export declare class GenericExtrinsicSignatureV4 extends Struct implements IExtrinsicSignature {
     ...
     */
    createPayload(method: Call, { blockHash, era, genesisHash, nonce, runtimeVersion: { specVersion, transactionVersion }, tip }: SignatureOptions): GenericExtrinsicPayloadV4;
    /**
