...
export class RpcCore {
  ...
  addUserInterfaces(userRpc) {
    ...
    this.sections.forEach(sectionName => {
      ...
      Object.entries(_objectSpread(_objectSpread({}, this._createInterface(sectionName, jsonrpc[sectionName] || {})), this._createInterface(sectionName, userRpc[sectionName] || {}))).forEach(([key, value]) => {
  ...
  _createMethodSend(section, method, def) {
    ...
    const callWithRegistry = async (outputAs, values) => {
      ...
      const {
        registry
      } = blockHash && _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry] ? await _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry](blockHash) : {
