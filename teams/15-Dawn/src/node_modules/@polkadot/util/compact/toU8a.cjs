...
function compactToU8a(_value) {
  ...
  if (value.lte(MAX_U8)) {
    ...
    return (0, _index.bnToU8a)(value.shln(2).addn(0b01), 16, true);
  } else if (value.lte(MAX_U32)) {
    return (0, _index.bnToU8a)(value.shln(2).addn(0b10), 32, true);
  }
  ...
  return (0, _index2.u8aConcat)(new Uint8Array([// substract 4 as minimum (also catered for in decoding)
