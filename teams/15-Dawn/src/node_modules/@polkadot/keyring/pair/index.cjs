...
function createPair({
  ...
  return {
    ...
    verify: (message, signature, _signerPublic) => {
      return (0, _utilCrypto.signatureVerify)(message, signature, TYPE_ADDRESS[type]((0, _util.u8aToU8a)(_signerPublic))).isValid;
    },
    ...
    vrfVerify: (message, vrfResult, _signerPublic, context, extra) => {
      const signerPublic = TYPE_ADDRESS[type]((0, _util.u8aToU8a)(_signerPublic));

      if (type === 'sr25519') {
        return (0, _utilCrypto.schnorrkelVrfVerify)(message, vrfResult, publicKey, context, extra);
      }

      const result = (0, _utilCrypto.signatureVerify)(message, (0, _util.u8aConcat)(TYPE_PREFIX[type], vrfResult.subarray(32)), signerPublic);
